#!/usr/bin/env python3
"""Cross-check the KiCad-exported netlist against the Rev 2.0 design intent."""
import re
import sys

NET = r"C:\Users\izuku\AppData\Local\Temp\claude\C--Users-izuku-Documents-hakai-claud\5b48d870-2552-4ee6-a329-7bb2248b20f1\scratchpad\net.net"
...
EXPECT = {
    ...
    "BTN_RIGHT":    {("U4", "K2"), ("SW2", "2"), ("R16", "2"), ("C29", "1")},
    "BTN_SIDE_BACK": {("U4", "L1"), ("SW3", "2"), ("R17", "2"), ("C30", "1")},
    "BTN_SIDE_FWD": {("U4", "M2"), ("SW4", "2"), ("R18", "2"), ("C31", "1")},
    "ENC_A":        {("U4", "N1"), ("EC1", "A"), ("R19", "2"), ("C32", "1")},
    "ENC_B":        {("U4", "T2"), ("EC1", "B"), ("R20", "2"), ("C33", "1")},
    "ENC_SW":       {("U4", "U1"), ("SW5", "1"), ("R21", "2")},
    ...
    "VBAT_EN":      {("U4", "B13"), ("Q1", "1"), ("R10", "1")},
    "VBAT_DIV_LO":  {("R9", "2"), ("Q1", "3")},
    "DEC1":         {("U4", "C1"), ("C9", "1")},
    "DEC3":         {("U4", "D23"), ("C10", "1")},
...
RAIL_SUBSET = {
    ...
    "VBAT": {("U2", "2"), ("U2", "3"), ("J2", "1"), ("R8", "1"), ("TP5", "1")},
