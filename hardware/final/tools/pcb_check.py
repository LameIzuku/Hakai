...
# package-relative: netlist from <package>/build/net.net, board from <package>/
PROJ = os.path.normpath(os.path.join(os.path.dirname(os.path.abspath(__file__)), ".."))
PCB = os.path.join(PROJ, "hakai_mouse_final.kicad_pcb")
...
root = parse_sexp(open(os.path.join(PROJ, "build", "net.net"), encoding="utf-8").read())
