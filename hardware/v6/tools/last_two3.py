...
for t in board.GetTracks():
    ...
    if abs(sy-108.60)<0.02 and abs(ey-108.60)<0.02 and abs(sx-ex)>5:
...
c12=try_plans("GND",0.10,[
 [("via",148.00,108.70),
  ("seg",BC,148.00,108.70,146.30,108.70),
  ("seg",BC,146.30,108.70,146.30,110.35),("seg",BC,146.30,110.35,146.80,110.35)],
 [("via",148.00,108.72),
  ("seg",BC,148.00,108.72,146.25,108.72),
  ("seg",BC,146.25,108.72,146.25,110.40),("seg",BC,146.25,110.40,146.80,110.40)],
])
c19=try_plans("GND",0.10,[
 [("via",152.70,118.35),("seg",BC,152.70,118.35,153.45,119.10),
  ("seg",BC,153.45,119.10,153.45,122.30)],
 [("via",152.75,118.40),("seg",BC,152.75,118.40,153.42,119.10),
  ("seg",BC,153.42,119.10,153.42,122.30)],
])
