...
board = pcbnew.LoadBoard(os.path.join(PKG, "hakai_mouse_v6.kicad_pcb"))
...
bom_refs = set()
with open(os.path.join(PKG, "BOM_hakai_mouse_v6.csv"), newline='', encoding='utf-8-sig') as f:
...
rows = list(csv.reader(open(os.path.join(PKG, "Cost_Estimate_hakai_mouse_v6.csv"),
...
# --- 9. package inventory ------------------------------------------------------
required = ["hakai_mouse_v6.kicad_pro", "hakai_mouse_v6.kicad_sch",
            "hakai_mouse_v6.kicad_pcb", "hakai_mouse_v6_schematic.pdf",
            "board_top_render.png", "BOM_hakai_mouse_v6.csv",
            "Cost_Estimate_hakai_mouse_v6.csv", "README.md", "fp-lib-table",
...
print("\n" + ("PACKAGE VERIFICATION FAILED: " + ", ".join(fails) if fails
      else "V6.0 PACKAGE FULLY VERIFIED"))
